...
require_once BASEPATH . NORMAL_DIRECTORY .'/conf/config.php';
require_once BASEPATH . NORMAL_DIRECTORY .'/conf/config.aop.php';
...
$tpl = new Tpl();
$tpl->template_dir = BASEPATH.NORMAL_DIRECTORY."/templates/";
$tpl->compile_dir = BASEPATH.NORMAL_DIRECTORY."/templates_c/";
$tpl->config_dir = BASEPATH.NORMAL_DIRECTORY."/configs/";
$tpl->cache_dir = BASEPATH.NORMAL_DIRECTORY."/cache/";
